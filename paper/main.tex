...
Other approaches move beyond uniform positive--negative separation by distilling continuous teacher-score differences, as in MarginMSE and TAS-Balanced~\cite{hofstatter2020improving,hofstatter2021efficiently}, or by using relevance- and attribute-dependent margins in metric-learning objectives~\cite{zhou2020ladder,Jeong_2021_ICCV,Zhao2019}.
...
Product relevance is inherently compositional, as a relevant item may need to satisfy multiple positive and negative attribute constraints simultaneously.
...
CLIP learns a general shared space for images and text, whereas composed image-retrieval benchmarks and methods such as CIRR and CLIP4CIR focus on retrieving images that satisfy language-specified attribute modifications~\cite{pmlr-v139-radford21a,Liu_2021_ICCV,Baldrati_2022_CVPR}.
