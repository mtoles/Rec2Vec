...
Such embeddings are often used in tasks such as product search where fine-grained matching of details between the query and the document determine relevance.
